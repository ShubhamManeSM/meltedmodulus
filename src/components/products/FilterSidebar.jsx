    ...
    <aside className={`filter-sidebar ${isOpen ? 'open' : ''}`} id="filter-sidebar">
      ...
      <div className="filter-group">
        ...
        <label className="filter-option">
          <input type="checkbox" name="category" value="Gaming" checked={filters.categories.includes('Gaming')} onChange={handleCategoryChange} />
          Gaming
        </label>
        <label className="filter-option">
          <input type="checkbox" name="category" value="Home" checked={filters.categories.includes('Home')} onChange={handleCategoryChange} />
          Home
        </label>
        <label className="filter-option">
          <input type="checkbox" name="category" value="Tech" checked={filters.categories.includes('Tech')} onChange={handleCategoryChange} />
          Tech
        </label>
        <label className="filter-option">
          <input type="checkbox" name="category" value="Cosplay" checked={filters.categories.includes('Cosplay')} onChange={handleCategoryChange} />
          Cosplay
        </label>
        <label className="filter-option">
          <input type="checkbox" name="category" value="Toys" checked={filters.categories.includes('Toys')} onChange={handleCategoryChange} />
          Toys
        </label>
      </div>
